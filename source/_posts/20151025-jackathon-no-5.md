...
Andy explained that the book list contains several scientific books because Journalism could learn a lot from the Science tradition - be it Cognitive Psychology, which studies human thinking and biases, or Probability Theory, which studies uncertainty. Click here to see the [book list](https://docs.google.com/document/d/1TBDLthpxy4S_gaHcJB63RzQCcOlOwmceh-UBigx76yg/edit#heading=h.5kxx2s6j5imj) made by Andy and Tianyi.

![Book Stack](/blog/20151025-jackathon-no-5/Book-Stack.JPG)
...
Sally Chong, a video journalist with rich experience, chose the book The Signal and Noise by Nate Silver, a statistician as well as founder of the data journalism blog [FiveThirtyEight](http://fivethirtyeight.com/). The book tries to analyze how people predict future based on data about the past. She introduced three thinking patterns that would lead to flawed predictions.
...
![Yanan is presenting](/blog/20151025-jackathon-no-5/Yanan-Presenting.jpeg)
