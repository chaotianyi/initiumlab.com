...
Chao Tianyi, Researcher of Initium Lab, Hu Pili and Andy held a live data mining section demonstrating the potential use of the [Hong Kong District Council Election data](https://github.com/initiummedia/hk_district_council_election), as well as use of data processing tools such as Google Spreadsheet, Fusion Table, and Refine.
